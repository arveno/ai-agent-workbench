...
ruleTester.run('data-contract/no-forbidden-fields', noForbiddenFields, {
  ...
  invalid: [
    ...
    { code: 'const payload = { metadata: { sources } };', errors: [error] },
    ...
    { code: "const payload = { ['tokenUsage']: usage };", errors: [error] },
    { code: 'const payload = { [`tokenUsage`]: usage };', errors: [error] },
    { code: "const payload = { metadata: { ['sources']: value } };", errors: [error] },
    { code: 'const payload = { metadata: { [`source_count`]: value } };', errors: [error] },
    { code: "const result = { agentConclusion: { ['source']: value } };", errors: [error] },
    { code: 'const result = { agentConclusion: { [`conclusionSource`]: value } };', errors: [error] },
    { code: "const { ['tokenUsage']: usage } = modelTrace;", errors: [error] },
    { code: 'const { [`tokenUsage`]: usage } = modelTrace;', errors: [error] },
    { code: "const { metadata: { ['sources']: sources } } = payload;", errors: [error] },
    { code: "function render({ metadata: { ['source_count']: sourceCount } }) {}", errors: [error] },
    { code: "({ metadata: { ['sources']: sources } } = payload);", errors: [error] },
