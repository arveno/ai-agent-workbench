...
ruleTester.run('data-contract/no-forbidden-fields', noForbiddenFields, {
  ...
  invalid: [
    ...
    { code: 'const payload = { metadata: { provider } };', errors: [error] },
    { code: 'const payload = { metadata: { selectedModelId } };', errors: [error] },
    { code: 'const payload = { metadata: { modelErrorType } };', errors: [error] },
    { code: 'const payload = { metadata: { fallbackReason } };', errors: [error] },
    { code: 'const payload = { metadata: { usage } };', errors: [error] },
    { code: 'const payload = { metadata: { costEstimate } };', errors: [error] },
    ...
    { code: "const payload = { ['tokenUsage']: usage };", errors: [error] },
    { code: 'const payload = { [`tokenUsage`]: usage };', errors: [error] },
    { code: "const payload = { metadata: { ['provider']: provider } };", errors: [error] },
    { code: 'const payload = { metadata: { [`modelErrorType`]: modelErrorType } };', errors: [error] },
